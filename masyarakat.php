...
<head>
    ...
    <title>Aplikasi Pelaporan Pengaduan Masyarakat Disdukcapil Kota Langsa</title>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Aplikasi Pelaporan Pengaduan Masyarakat Disdukcapil Kota Langsa&copy2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
