                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Silakan Masukkan Biodata Untuk Mendaftar
                                            Aplikasi Pengaduan Masyarakat!</h1>
                                    </div>
                                    <form method="post" action="proses-register.php" class="user">
                                        ...
                                        <div class="form-group">
                                            <input name="telp" type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                        ...
                                        <a href="index.php" class="btn btn-success btn-user btn-block">
                                            <i class="fa fa-laptop fa-fw"></i> Sudah Pnya Akun...? Silakan Login
                                        </a>
                                    </form>
                                </div>
                            </div>
